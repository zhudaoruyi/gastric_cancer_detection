...
csvlogger = CSVLogger('log10032100_05.log', append=True)
model_check = ModelCheckpoint('model10032100_05_p.h5', monitor='val_loss', save_best_only=True)
...
model.save('model10032100_05.h5')
