...
csvlogger = CSVLogger('log10032100_03.log', append=True)
model_check = ModelCheckpoint('model10032100_03_p.h5', monitor='val_loss', save_best_only=True)
...
model.save('model10032100_03.h5')
